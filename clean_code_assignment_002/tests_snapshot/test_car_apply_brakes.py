...
# ----Task5----Apply Brakes----
def test_apply_break_when_current_speed_less_than_or_equal_to_tyre_friction(snapshot):
    # Arrange
...
def test_apply_break_multiple_times_returns_current_speed(snapshot):
    # Arrange
...
def test_apply_brake_after_starting_engine_returns_zero(snapshot):
    # Arrange
...
def test_apply_break_when_car_engine_is_not_started_returns_current_speed_zero(
        car_obj1, snapshot):
    # Assert
